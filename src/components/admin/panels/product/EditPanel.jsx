...
export default function EditPanel({
    ...
    const btnLight = "admin-btn-light";
    ...
    const care = CARE_DEFAULTS.map((def, i) => rawCare[i] ? { ...def, ...rawCare[i] } : { ...def });

    function updateCareTip(index, field, value) {
        const updated = care.map((t, i) => i === index ? { ...t, [field]: value } : t);
        ...
        <div className="h-screen w-[600px] xl:w-[400px] flex flex-col gap-3 overflow-hidden p-4 bg-admin-card-edit tablet:rounded-md">
                <div className="shrink-0 flex flex-col gap-4">
                    ...
                    <div className="flex justify-between items-end gap-4 max-[640px]:flex-col">
                        ...
                        <div className="flex flex-col gap-2 max-[1080px]:w-full">
                                            <div className="flex flex-row items-center gap-1">
                                                <label htmlFor="updated_at" className="text-xs min-w-8">更新<br/>日期</label>
                                                <input
                                                    id="updated_at"
                                                    type="date"
                                                    name="updated_at"
                        ...
                        {activeTab === 'content' && (
                            <div className="flex flex-col gap-4">
                                <div className="flex flex-col gap-1">
                                    <label htmlFor="content" className="text-xs font-semibold text-slate-500">規格說明</label>
                                    <textarea
                                        id="content"
                                        name="content"
                                        placeholder="請輸入規格說明"
                                ...
                                <div className="flex flex-col gap-1">
                                    <label htmlFor="description" className="text-xs font-semibold text-slate-500">描述</label>
                                    <textarea
                                        id="description"
                                        name="description"
                                        placeholder="請輸入商品描述"
                                ...
                                <div className="flex flex-col gap-1">
                                    <label htmlFor="story" className="text-xs font-semibold text-slate-500">故事（選填）</label>
                                    <textarea
                                        id="story"
                                        name="story"
                                    ...
                                    <div key={i} className="flex items-start gap-2">
                                        ...
                                        <div className="flex flex-col gap-1 flex-1 min-w-0">
                                            <input
                                                ...
                                                placeholder="標題"
                                                value={tip.title || ''}
                                                onChange={e => updateCareTip(i, 'title', e.target.value)}
                                                className={inputBase}
                                            />
                                            <textarea
                                                placeholder="說明文字"
                                                value={tip.description || ''}
                                                onChange={e => updateCareTip(i, 'description', e.target.value)}
                                                className={`${inputBase} resize-none`}
                                                rows={2}
                                            />
                                        </div>
