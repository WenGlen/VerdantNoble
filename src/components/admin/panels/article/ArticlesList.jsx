        ...
        <table ref={tableRef} className="border-collapse text-admin-text">
          <thead>
            <tr className="text-center bg-slate-200 text-sm">
              <th className="" />
              <th className="min-w-[220px] max-w-[220px] py-2 text-left px-3">
                標題
              </th>
            ...
            {currentArticles.map((article, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="text-center text-xs min-w-[70px] py-2 px-3">
                    {article.author}
                  </td>
                  ...
                  <td className="text-center min-w-[90px] py-2 px-3 text-xs">
