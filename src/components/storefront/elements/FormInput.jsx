...
const FormInput = forwardRef(function FormInput({ label, error, ...inputProps }, ref) {
    return (
 ...
 */
const FormTextarea = forwardRef(function FormTextarea({ label, error, ...textareaProps }, ref) {
    return (
        <label className="w-full flex flex-col gap-1 md:flex-row md:items-start md:gap-2">
            <span className="form-label pt-2">{label}</span>
            <div className="flex-1 min-w-0 flex flex-col gap-1">
