...
export default function MainLayout({ headerNavItems, footerNavItems }) {
  ...
  return (
    <div className="min-h-screen flex flex-col w-full">
      ...
      <header className="header fixed top-0 left-0 right-0 z-50 w-full">
        {/* 桌面版選單 */}
        <div
          className="relative w-full h-16 backdrop-blur-sm bg-background-50 border-b border-border-25 
                                hidden
                                md:block "
        >
          <div className="w-full max-w-screen-xl mx-auto flex-row-between-center gap-4 py-2 px-8">
            ...
            <div
              className="nav w-full max-w-[600px] md:min-w-[480px]
                                        flex justify-evenly
                                        text-lg"
            >
            ...
            <div
              /*header-actions*/ className=" flex-row-center-center gap-4 py-2 flex-shrink-0"
            >
              <Link to="/order" className="btn-icon relative">
                <img src={cartIcon} alt="購物車" className="w-8 h-8" />
                {cartCount > 0 && (
                  <div
              ...
              <Link to="/user/orders" className="btn-icon">
                <img src={userIcon} alt="會員與訂單" className="w-10 h-10" />
              </Link>
            </div>
          </div>
        ...
        {/* 手機版選單 */}
        <div
          className="fixed top-4 right-4 flex gap-6 z-50
                                                block
                                                md:hidden"
        >
          <Link to="/order" className="btn-icon relative">
          ...
          >
            <div
              className="w-8 h-8 flex-col-center
        ...
        <div
          className={`fixed top-0 right-0 z-40 w-full h-full 
        ...
        >
          ...
          <div className="w-full px-8 flex-col-center-end gap-8">
            <button onClick={() => setIsMobileMenuOpen(false)}>
              <Link to="/" className="">
                <img src={logo} alt="綠蕨飾品牌標誌" className="w-36" />
              </Link>
            </button>
            <button
              className="flex-col-center-center gap-8"
      ...
      <footer
        className="w-full backdrop-blur-sm bg-background-25
            ...
            <div className="w-full flex flex-col md:flex-row items-center md:gap-8">
              ...
              <form className="w-full flex-col-start gap-2 text-xs">
                ...
                <div className="w-full flex-row-start">
                  ...
                  />
                  <button className="btn-panel rounded-l-none rounded-r-sm w-24">
                    訂閱
                  </button>
                </div>
              </form>
