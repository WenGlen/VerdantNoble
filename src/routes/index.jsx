...
import CouponsManagement from "../views/admin/CouponsManagement/CouponsManagement.jsx";
...
import CouponsIcon from "../img/Coupons.png";
...
const storefrontPages = {
  ...
  order: [{ path: "order", element: <OrderLayout />, title: "購物車" }],
  // user使用者頁面有巢狀結構，直接寫在下面
  notFound: [{ path: "*", element: <NotFoundPage />, title: "頁面不存在" }],
  APITest: [{ path: "api-test", element: <APITestPage />, title: "API測試" }],
};
...
const adminPages = [
  ...
  {
    path: "ProductsMark",
    element: <ProductsMark />,
    title: "商品標籤",
    icon: ProductsMarkIcon,
  },
  {
  ...
  {
    path: "ArticlesMark",
    element: <ArticlesMark />,
    title: "文章標籤",
    icon: ArticlesMarkIcon,
  },
  {
